...
/**
 * This is the model class for table "fd_budget_type".
 *
 * The followings are the available columns in table 'fd_budget_type':
 * @property integer $id
...
class BudgetType extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			...
			'campaigns' => array(self::HAS_MANY, 'Campaign', 'budget_type_id'),
		);
	}
