...
/**
 * This is the model class for table "{{campaign_stats_summary}}".
 *
 * The followings are the available columns in table '{{campaign_stats_summary}}':
 * @property integer $id
 ...
 */
class CampaignStatsSummary extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return CampaignStatsSummary the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('campaign_id, sitescout_campaign_id, status_id, impressionsBid, impressionsWon, clicks, offerClicks, viewthruConversions, create_user_id, update_user_id', 'numerical', 'integerOnly'=>true),
	...
	public function attributeLabels()
	{
		return array(
			...
			'revenue' => 'Revenue',
			'totalEffectiveCPM' => Yii::t('CampaignStats', 'effectiveCPM'),
