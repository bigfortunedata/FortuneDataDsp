...
/**
 * This is the model class for table "fd_creative_type".
 *
 * The followings are the available columns in table 'fd_creative_type':
 * @property integer $id
 ...
 */
class CreativeType extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return CreativeType the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'creatives' => array(self::HAS_MANY, 'Creative', 'type_id'),
