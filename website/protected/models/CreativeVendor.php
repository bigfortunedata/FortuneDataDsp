...
/**
 * This is the model class for table "fd_creative_vendor".
 *
 * The followings are the available columns in table 'fd_creative_vendor':
 * @property integer $id
 ...
 */
class CreativeVendor extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return CreativeVendor the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'creatives' => array(self::HAS_MANY, 'Creative', 'vendor_id'),
