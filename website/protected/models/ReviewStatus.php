...
/**
 * This is the model class for table "fd_review_status".
 *
 * The followings are the available columns in table 'fd_review_status':
 ...
 */
class ReviewStatus extends CActiveRecord
{
	/**
